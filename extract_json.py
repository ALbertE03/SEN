    ...
    def __init__(self, 
        ...
        try:
            with open(path_template, 'r', encoding='utf-8') as template_file:
                ...
                self.json_template = json.dumps(template_data["2025"]["enero"][0]["datos"], ensure_ascii=False, indent=4)
...
Para campos desconocidos usa null, no inventes datos. No añadas campos adicionales al JSON."""
    ...
    def extract_json_from_text(self, text: str) -> Optional[Dict]:
        ...
        try:
            ...
            if response.status_code != 200:
                print(f"Error en la API (código {response.status_code}): {response.text}")
                return None
    ...
    def process_all_reports(self, delay: int = 2, output_dir: str = 'data', save_individual: bool = False) -> None:
        """
    ...
    def save_results(self, output_dir: str = 'data') -> None:
        ...
        """
        if not any(self.organized_data[año][mes] for año in self.organized_data for mes in self.organized_data[año]):
    ...
    def run_pipeline(self, delay: int = 2, output_dir: str = 'data', save_individual: bool = False) -> int:
        """
